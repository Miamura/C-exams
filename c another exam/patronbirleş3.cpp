    ...
    int kayit_ekle()
{
    ...
    printf("%ld.kisi tc sini giriniz\n",sayac+1);
    
    for( ; ; ){
        fgets(gecici,sizeof(gecici),stdin);
        if( strlen(gecici) == 12 ){
            kisi[sayac].tc = atol(gecici);
            if( kisi[sayac].tc > 1000000000 ) break;
        }
    }
    ...
    for( ; ; ){
        ...
        if( strlen(gecici) == 11 ){
            ...
            if( kisi[sayac].tel > 100000000 ) break;
        }
    }
...
int listele()
{
   ...
   while(!feof(dosya)){//dosya sonuna kadar dön
        ...
        fscanf(dosya,"%s%s%ld%d",kisiokuma[sayac2].isim,kisiokuma[sayac2].soyadi,&kisiokuma[sayac2].tc,&kisiokuma[sayac2].tel);
...
int ara_bul()
{
    ...
    while(!feof(dosya)){//dosya sonuna kadar dön
        ...
        fscanf(dosya,"%s%s%ld%d",kisiokuma[sayac3].isim,kisiokuma[sayac3].soyadi,&kisiokuma[sayac3].tc,&kisiokuma[sayac3].tel);//dosyadan veriler okunup yedek yapýsýna aktarýlýyor
...
int bul_degistir()
{
    ...
    while(!feof(dosya)){//dosya sonuna kadar dönülüyor baþlangýç
        ...
        fscanf(dosya,"%s%s%ld%d",kisiokuma[sayac4].isim,kisiokuma[sayac4].soyadi,&kisiokuma[sayac4].tc,&kisiokuma[sayac4].tel);//dosyadan alýnan veriler yedek yapýsýna aktarýlýyor
    ...
    for(i=0;i<(sayac4-1);i++){//yedek yapýsýna alýnan verilerin iþleme sokulmasý
 ...
 
        {
            ...
            printf("%ld. kisinin tcsini giriniz",i+1);//kullanýcýdan yeni vize isteniyor
            
            scanf("%ld",&kisiokuma[i].tc); //vize yedek yapýsýnýn deðiþecek kýsmýna atanýyor
...
int kayit_sil()
{
    ...
    while(!feof(dosya)){//dosya sonuna kadar dönülüyor baþlangýç
        ...
        fscanf(dosya,"%s%s%ld%d",kisiokuma[sayac5].isim,kisiokuma[sayac5].soyadi,&kisiokuma[sayac5].tc,&kisiokuma[sayac5].tel);//dosyadan alýnan veriler yedek yapýsýna aktarýlýyor
